...
# 插入医保缴纳记录的接口
@app.route('/api/medical_insurance_payments', methods=['POST'])
def insert_medical_insurance_payment():
    try:
        # 获取请求中的 JSON 数据
        ...
        VALUES (%s, %s, %s, %s, %s)
        """
        values = (date, personal_payment, company_payment, personal_account, remarks)
